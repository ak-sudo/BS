...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	    ...
	    <div id="popupmain" style=" position: fixed; width: 100%; height: 100%; background: rgba(0,0,0,0.6); z-index:1001;">
		<div id="popup" style=" width: 500px; height: 200px; background: blue; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
			<h1 id="newheading"> Get news from our website. </h1>
